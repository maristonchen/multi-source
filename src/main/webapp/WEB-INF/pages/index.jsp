...
<div id="wrapper">
    ...
    <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="#">自动出票后台管理系统</a>
        </div>
        <!-- /.navbar-header -->
        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="${ctx}/ticket/toPage"><i class="fa fa-table fa-fw"></i> 机票信息列表</a>
                    </li>
                    <li>
                        <a href="${ctx}/third/toPage"><i class="fa fa-dashboard fa-fw"></i>第三方平台</a>
                    </li>
                    <li>
                        <a href="${ctx}/autout/toPage"><i class="fa fa-edit fa-fw"></i> 自动出票</a>
                    </li>
                    <li>
                        <a href="${ctx}/b2b/toPage"><i class="fa fa-edit fa-fw"></i>B2B信息</a>
                    </li>
                    <li>
                        <a href="#"><i class="fa fa-wrench fa-fw"></i> UI元素<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="panels-wells.html">全版</a>
                            </li>
                        </ul>
                        <!-- /.nav-second-level -->
                    </li>
...
<script src="${ctx}/module/index/index.js"></script>
</body>
</html>